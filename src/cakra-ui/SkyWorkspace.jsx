...
export default function SkyWorkspace({ data, loading, expanded = false }) {
  ...
  return (
    <motion.div
      variants={item}
      className="relative h-full min-h-[430px] overflow-hidden rounded-[20px] border border-[#1B4E6A] bg-[radial-gradient(circle_at_50%_42%,rgba(56,189,248,0.1),transparent_27%),radial-gradient(circle_at_50%_72%,rgba(124,58,237,0.08),transparent_34%),linear-gradient(180deg,#061625_0%,#03101D_62%,#020A13_100%)]"
      aria-label="Celestial sky workspace"
    >
      ...
      <div className={`absolute inset-x-4 top-4 z-20 flex items-center justify-between font-bold uppercase tracking-[0.16em] text-[#62A5C7] ${expanded ? "text-[10px] sm:inset-x-5 sm:text-[11px]" : "text-[8px] sm:inset-x-5 sm:text-[9px]"}`}>

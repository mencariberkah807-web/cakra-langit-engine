...
export default function Footer({ data }) {
  ...
  return (
    <footer
      ...
      className="border-t border-white/10 bg-[#07111C]"
    >
      <div className="mx-auto flex max-w-[1440px] flex-wrap items-center gap-x-10 gap-y-2 px-4 py-3.5 text-xs text-slate-400 sm:px-6 lg:px-8">
        ...
        <span className="flex items-center gap-2 font-medium text-slate-200" data-testid="footer-status-ok">

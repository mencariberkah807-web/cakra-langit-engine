        ...
        <div className="mx-auto max-w-[1500px]">
          ...
          <section className="mt-8">
            ...
            <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
              ...
              <DetailCard tone="blue" icon={Waves} title="Tide · Ocean" primary={tide.available === false ? "Tide model unavailable" : tide.status || tide.location || "—"} secondary={tide.reason || (ocean.available === false ? "No marine data" : ocean.secondary)} rows={[["High tide", formatObservationValue(tide.high)], ["Low tide", formatObservationValue(tide.low)], ["Marine", ocean.available === false ? "No marine data" : formatObservationValue(ocean.primary)], ["Marine source", formatObservationValue(ocean.source)]]} />
